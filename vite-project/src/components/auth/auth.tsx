...
const AuthPage: React.FC<AuthPageProps> = (props) => {
  ...
  const onLogin = (e: FormEvent) => {
    e.preventDefault();
    axios
      .post("http://localhost:5000/login", { username, secret })
  ...
  return (
    <div className="login-page">
      ...
      input { width: calc(100% - 16px); margin-top: 12px; padding: 8px; background-color: #e6f7ff; outline: none; border: 1px solid #e6f7ff; color: black; }
